...
//
//        if (url.contains("login.jsp") || url.contains("home.jsp")) {
//            httpResponse.sendRedirect(contextPath + "/login");
//        } else {
//            httpRequest.getRequestDispatcher("/view/NotFound.jsp").forward(httpRequest, httpResponse);
//        }
//        
